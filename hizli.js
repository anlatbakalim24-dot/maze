...
{ s: "Sibel Kekilli, 'Duvara Karşı' filmindeki rolüyle Avrupa'nın Oscarları sayılan Avrupa Film Ödülleri'nde (EFA) hangi dalda ödül almıştır?", c: ["En İyi Kadın Oyuncu", "En İyi Çıkış Yapan Oyuncu", "Jüri Özel Ödülü"], a: "En İyi Kadın Oyuncu" },
    ...
    { s: "Dünyanın en derin gölü olan ve toplam tatlı su rezervinin yaklaşık %20'sini barındıran göl hangisidir?", c: ["Hazar Denizi", "Baykal Gölü", "Superior Gölü"], a: "Baykal Gölü" },
    { s: "Afrika Kıtası'nın en büyük gölü olan ve Nil Nehri'nin ana kaynaklarından birini oluşturan göl hangisidir?", c: ["Tanganika Gölü", "Viktorya Gölü", "Malavi Gölü"], a: "Viktorya Gölü" },
    { s: "Türkiye'nin en büyük sodalı gölü olan Van Gölü'nde, dünyada sadece bu gölde yaşayan balık türü hangisidir?", c: ["İnci Kefali", "Siraz Balığı", "Gümüş Balığı"], a: "İnci Kefali" },
